...
import nl.jellejurre.seedchecker.serverMocks.FakeMinecraftServer;
...
public class FakeServerWorld extends ServerWorld {
    ...
    public FakeServerWorld(MinecraftServer server,
        ...
        entityManager = new ServerEntityManager(Entity.class, new FakeServerEntityHandler(), chunkDataAccess);
